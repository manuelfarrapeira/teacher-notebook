  ...
  es: {
    ...
    dashboard: {
      ...
      rubrics: {
        ...
        createExercise: 'Crear Rúbrica',
        editExercise: 'Editar Rúbrica',
        editGrade: 'Editar Nota',
        createGrade: 'Añadir Nota',
        exerciseTitle: 'Título de la rúbrica',
        ...
        grade: 'Nota',
        noExercises: 'No hay rúbricas para esta asignatura y trimestre',
        ...
        deleteExerciseTitle: 'Eliminar rúbrica',
        deleteExerciseConfirm: '¿Está seguro que desea eliminar la rúbrica "{name}"? Se eliminarán también todas sus notas y documentos. Esta acción no se puede deshacer.',
        deleteGradeTitle: 'Eliminar nota',
        deleteGradeConfirm: '¿Está seguro que desea eliminar la nota de la rúbrica "{name}"? Esta acción no se puede deshacer.',
        createExerciseSuccess: 'Rúbrica creada correctamente',
        createExerciseError: 'Error al crear la rúbrica',
        updateExerciseSuccess: 'Rúbrica actualizada correctamente',
        updateExerciseError: 'Error al actualizar la rúbrica',
        deleteExerciseSuccess: 'Rúbrica eliminada correctamente',
        deleteExerciseError: 'Error al eliminar la rúbrica',
  ...
  en: {
    ...
    dashboard: {
      ...
      rubrics: {
        ...
        quarter2: 'Quarter 2',
        quarter3: 'Quarter 3',
        createExercise: 'Create Rubric',
        editExercise: 'Edit Rubric',
        editGrade: 'Edit Grade',
        createGrade: 'Add Grade',
        exerciseTitle: 'Rubric title',
        ...
        maxGrade: 'Max grade',
        grade: 'Grade',
        noExercises: 'No rubrics for this subject and quarter',
        ...
        deleteExerciseTitle: 'Delete rubric',
        deleteExerciseConfirm: 'Are you sure you want to delete the rubric "{name}"? All grades and documents will also be deleted. This action cannot be undone.',
        deleteGradeTitle: 'Delete grade',
        deleteGradeConfirm: 'Are you sure you want to delete the grade for rubric "{name}"? This action cannot be undone.',
        createExerciseSuccess: 'Rubric created successfully',
        createExerciseError: 'Error creating rubric',
        updateExerciseSuccess: 'Rubric updated successfully',
        updateExerciseError: 'Error updating rubric',
        deleteExerciseSuccess: 'Rubric deleted successfully',
        deleteExerciseError: 'Error deleting rubric',
